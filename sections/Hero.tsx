	...
	return (
		<div className='h-full flex justify-evenly items-center gap-8 mx-10 max-[375px]:flex-col'>
			<div className='flex flex-col justify-center items-center'>
				...
				<Button className='w-[160px] h-[50px] mt-10 rounded-3xl text-lg hover:btn_hover siemreap max-[375px]:w-[100px] max-[375px]:h-[40px] max-[375px]:text-sm' onClick={()=>{alert('Register')}}>ចុះឈ្មោះ</Button>
			</div>
