			...
			<CarouselContent className='sm:gap-2 section-h w-11/12 max-sm:w-[48%]'>
					...
					<CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
						...
						<div className='w-11/12 max-sm:w-full h-[500px] max-sm:h-[250px] flex flex-col sm:margin-center shadow-md hover:shadow-xl rounded-lg'>
							...
							<p className='font-bold my-4 max-sm:my-1 ml-4 max-sm:ml-1 max-sm:px-1 max-sm:text-[9px] siemreap'>{data.title}</p>
							<p className='text-ellipsis overflow-hidden whitespace-pre-line flex-1 mx-4 mb-2 max-sm:ml-1 max-sm:px-1 max-sm:text-[7px] siemreap'>{data.details}</p>
